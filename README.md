...
Project based on [Roadmap.sh](https://roadmap.sh/projects/github-user-activity) requirements.

In this project, you will build a simple command line interface (CLI) to fetch
...
working with APIs, handling JSON data, and building a simple CLI application.

## Requirements

The application should run from the command line, accept the GitHub username as
an argument, fetch the user’s recent activity using the GitHub API,
...
you can consider adding features like:
...
You can also explore other endpoints of the GitHub API
to fetch additional information about the user or their repositories.
